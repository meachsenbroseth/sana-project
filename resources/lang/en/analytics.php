...
return [
    ...
    'kpis' => [
        'today'               => 'Today',
        'pending'             => 'pending',
        'customers_desc'      => 'Registered customers',
        'products_desc'       => 'Active products',
        'orders_today_desc'   => 'Placed today',
        'pending_orders_desc' => 'Awaiting action',
        'no_data'             => 'No revenue yet',
        'aov_desc'            => ':value per paid order',
        'revenue_today_desc'  => ':percent% of total revenue',
        'total_revenue'       => 'Total Revenue',
        'revenue_today'       => 'Revenue Today',
        'pending_orders'      => 'Pending Orders',
        'orders_today'        => 'Orders Today',
