        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-12 lg:gap-8 mb-16">
            ...
            <div>
                ...
                <ul class="space-y-4 text-sm">
                    ...
                    <li><a wire:navigate href="#" class="text-gray-400 hover:text-white transition uppercase">Contact Us</a></li>
                </ul>
            </div>
            ...
            <div>
                ...
                <a wire:navigate href="tel:012689168" class="block text-2xl font-bold text-white hover:text-blue-500 transition mb-6">
                    012 689 168
                </a>
                ...
                <div class="space-y-4 text-sm text-gray-400">
                    ...
                    <div>
                        <a href="https://maps.app.goo.gl/gL24Z4UZCvQ986ABA" 
