    ...
    <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 lg:gap-8 mb-16">
            ...
            <div>
                ...
                <ul class="space-y-4 text-sm">
                    <li><a href="{{ route('products.index') }}"
                            class="text-gray-400 hover:text-white transition uppercase">Shop Now</a></li>
                    <li><a href="{{ route('customer.dashboard') }}"
                            class="text-gray-400 hover:text-white transition uppercase">My Account</a></li>
                    <li><a href="{{ route('customer.orders') }}"
                            class="text-gray-400 hover:text-white transition uppercase">Order Tracking</a></li>
                    <li><a href="{{ route('customer.profile') }}"
                            class="text-gray-400 hover:text-white transition uppercase">Profile Settings</a></li>
                    <li><a href="#" class="text-gray-400 hover:text-white transition uppercase">About Us</a></li>
                    <li><a href="#" class="text-gray-400 hover:text-white transition uppercase">Contact Us</a>
                    </li>
                    <li><a href="#" class="text-gray-400 hover:text-white transition uppercase">FAQ &
                            Questions</a></li>
                </ul>
            </div>
            ...
            <div>
                ...
                <ul class="space-y-4 text-sm">
                    <li><a href="#" class="text-gray-400 hover:text-white transition uppercase">Terms &
                            Conditions</a></li>
                    <li><a href="#" class="text-gray-400 hover:text-white transition uppercase">Privacy Policy</a>
                    </li>
                    <li><a href="#" class="text-gray-400 hover:text-white transition uppercase">Warranty
                            Policy</a></li>
                    <li><a href="#" class="text-gray-400 hover:text-white transition uppercase">Return &
                            Refund</a></li>
                    <li><a href="#" class="text-gray-400 hover:text-white transition uppercase">Shipping &
                            Delivery</a></li>
                </ul>
            </div>
            ...
            <div>
                ...
                <div class="space-y-4 text-sm text-gray-400">
                    <div class="flex items-start gap-3">
                        <svg class="w-5 h-5 mt-0.5 text-gray-500" fill="none" stroke="currentColor"
                            viewBox="0 0 24 24">
                    ...
                    <div class="flex items-start gap-3">
                        ...
                        <span class="leading-relaxed">Phanna Computer, No 114, Road 138 Teuk Laak 2, near Santor Mok
                            School,<br> Phnom Penh (Visit & Store Pickup)</span>
                    </div>
                </div>
            </div>
