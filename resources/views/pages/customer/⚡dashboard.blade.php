...
new class extends Component {
    ...
    public function getStatsProperty()
    {
        ...
        return [
            ...
            'pending_orders' => $this->customer->orders()->where('status', 'pending')->count(),
            'total_spent' => $this->customer->orders()->where('payment_status', 'paid')->sum('total'),
        ];
    }
};
?>
...
<div class="py-8">
    ...
    <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div
            class="bg-white rounded-xl shadow-sm p-6 mb-8 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-6">
            ...
            <div class="flex items-center gap-4">
                ...
                <div class="h-14 w-14 rounded-full overflow-hidden bg-gray-100 flex items-center justify-center">
                    @if ($this->customer?->avatar)
                        <img src="{{ $this->customer->avatar }}" alt="{{ $this->customer->name }}"
                            class="h-full w-full object-cover">
                    @else
                        <span class="text-lg font-semibold text-blue-600">
                            {{ strtoupper(substr($this->customer?->name ?? 'U', 0, 1)) }}
                        </span>
                    @endif
                </div>
            ...
            <div class="bg-white rounded-lg shadow-sm p-6">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-3xl font-bold text-gray-900">{{ $this->stats['total_orders'] }}</p>
                    </div>
            ...
            <div class="bg-white rounded-lg shadow-sm p-6">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-3xl font-bold text-gray-900">{{ $this->stats['pending_orders'] }}</p>
                    </div>
            ...
            <div class="bg-white rounded-lg shadow-sm p-6">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-3xl font-bold text-gray-900">${{ number_format($this->stats['total_spent'], 2) }}
                        </p>
                    </div>
                    ...
                    <div class="space-y-3">
                        ...
                        <form method="POST" action="{{ route('logout') }}">
                            ...
                            <button type="submit"
                                ...
                                <div
                                    class="w-10 h-10 bg-red-100 text-red-600 rounded-lg flex items-center justify-center group-hover:bg-red-600 group-hover:text-white transition">
                                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
