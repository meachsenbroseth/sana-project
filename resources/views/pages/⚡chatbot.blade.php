    ...
    <div class="mx-auto max-w-5xl px-4 sm:px-6 lg:px-8">
        <nav class="mb-6 text-sm">
            <ol class="flex items-center gap-2">
                <li><a wire:navigate href="{{ route('home') }}" class="text-gray-500 hover:text-blue-600">ទំព័រដើម</a></li>
        ...
        <div class="mb-6 rounded-xl border border-blue-100 bg-gradient-to-br from-blue-50 to-indigo-50 p-6">
            ...
            <p class="mt-2 text-sm text-gray-700 sm:text-base">
                អ្នកអាចសួរអំពី Laptop, Accessories និងការប្រៀបធៀបផលិតផលក្នុងហាងរបស់យើង។</span>.
            </p>
