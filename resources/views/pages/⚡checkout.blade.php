        ...
        try {
            ...
            if ($this->paymentMethod === 'khqr') {
                return redirect()->route('customer.orders.show', $order->id)
                    ->with('success', 'Order placed successfully! Please complete your KHQR payment.');
            } else {
                return redirect()->route('customer.orders.show', $order->id)
                                    ...
                                    @foreach($this->addresses as $address)
                                        <label class="relative cursor-pointer">
                                            <input type="radio"
                                                   ...
                                                   value="{{ $address->id }}"
                                                   class="peer sr-only">
                                            <div class="border-2 rounded-lg p-4 peer-checked:border-blue-600 peer-checked:bg-blue-50 hover:border-blue-400 transition">
                                                <div class="flex items-start justify-between">
                                                    <div>
                                                        ...
                                                        @if($address->is_default)
                                                            <span class="inline-block mt-2 bg-blue-100 text-blue-800 text-xs px-2 py-1 rounded">
                                                                Default
                                                            </span>
                                                        @endif
                                                    </div>
                ...
                @if($step === 3)
                    <div class="bg-white rounded-lg shadow-sm p-6">
                        ...
                        <div class="space-y-4 mb-6">
                            ...
                            @if(Setting::get('khqr_enabled', false))
                            <label class="relative cursor-pointer">
                                <input type="radio"
                                       wire:model="paymentMethod"
                                       value="khqr"
